...
//   const CACHE_EXPIRATION_KEY = 'weatherDataExpiration';
...
//       setForecastData(cachedWeather.forecastData);
//       setLoading(false);
//       return;
//     }
...
//         CACHE_KEY,
//         JSON.stringify({ weatherData: weather, forecastData: forecast })
//       );
...
//                     aria-expanded={index === 0} // Expand first item by default
